...
public class transcation implements Comparable{
	int txId;
	LocalDate txDate;
	float txAmount;
	boolean txArears; 
	boolean txStatus;
	transcation(int txId,LocalDate txDate,float txAmount,boolean txArears, boolean txStatus){
		this.txId=txId;
		this.txArears=txArears;
		this.txDate=txDate;
